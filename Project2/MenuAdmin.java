...
public class MenuAdmin{
	...
	public static void addSubCategories(String line, int index_category, ArrayList<String[]> subcategories,ArrayList<Integer[]> prices){// index_category = 1
		...
		//prices = { null ,   [100,200] , [200, 200]      }  
		//subctg = { null ,   [sub1,sub2] , [sub3, sub4]      }   // 2     sub3, sub4
		//subctg = { null ,   [sub1,sub2,sub3,sub4] , [sub3, sub4]      }   // 2     sub3, sub4
		//prices = { null ,   [100,200,null,null] , [200, 200]      }  
		else{	
